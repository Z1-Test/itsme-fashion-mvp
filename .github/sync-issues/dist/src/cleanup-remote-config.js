...
import { readFile, listMarkdownFiles, fileExists, getAccessToken, fetchTemplate, findIssueByTitle, closeIssue, log, } from "../lib/effects.js";
 ...
 */
const getFlagKeysFromDocs = (featuresDir) => {
    const keys = new Set();
 ...
 */
const closeFlagIssue = (flagKey, dryRun) => {
...
//# sourceMappingURL=cleanup-remote-config.js.map