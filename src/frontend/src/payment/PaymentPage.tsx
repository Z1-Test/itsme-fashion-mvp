      ...
      <div className={styles.card}>
        ...
        {!isPaid ? (
          ...
          <div className={styles.success}>
            <svg width="56" height="56" fill="none" viewBox="0 0 24 24"><circle cx="12" cy="12" r="12" fill="#0f0"/><path d="M7 13l3 3 7-7" stroke="#fff" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/></svg>
            <div style={{fontWeight:700,fontSize:'1.3rem',marginTop:'1rem'}}>Payment Successful!</div>
            <div style={{marginTop:'0.5rem'}}>Thank you for your order.</div>
          </div>
        )}
      </div>
    </div>
